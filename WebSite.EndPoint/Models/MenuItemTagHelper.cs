...
{
    /// <summary>
    /// بخش های دینامیک نمایش دسته بندی را از کاتالوگ تایپ اخذ 
    /// و در 
    /// </summary>
    ...
    public class MenuItemTagHelper : TagHelper
    {
        ...
        {
            ///ایجاد تگ یو ال در  <ul>
            output.TagName = "ul";
            ///تمام محتوای داینامیک اچ تی ام ال 
            output.Content.AppendHtml(GetContent());
        }
        private TagBuilder GetContent()
        {
            ///سرویس اخذ منو را اینجکت میکنیم 
            var data = getMenuItemService.Execute();
            ///تگ یو ال در بالا ایجاد شد اکنون محتوا را در تگ ال آی ایجاد میکنیم
            ...
            foreach (var item in data.Where(p => p.ParentId == null))
            {
                ...
                {
                    ///یک لینک برای کالاها توسط منو ایجاد میکنیم 
        ...
        /// <summary>
        /// برای ایجاد تگ آ که درون خود تگ ال آی دارد
        /// </summary>
