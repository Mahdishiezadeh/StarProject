...
namespace Application.Discounts.AddNewDiscountServices
{
    ...
    public class AddNewDiscountService : IAddNewDiscountService
    {
        ...
        {
            ///ابتدا دیسکانت ورودی را مپ میکنیم
            ...
            {
                ///دی تی او دیسکانت ی که با پراپرتی اپلید تو کاتلوگ آیتم ، آیدی محصول همراه داشت با آیدی محصولات مطابقت بده و لیست کن
                var catalogItems = context.CatalogItems
                    .Where(p => discount.appliedToCatalogItem.Contains(p.Id))
                    .ToList();

                ///پراپرتی کاتالوگ آیتم در موجودیت دیسکانت را مقداردهی کن
    ...
    public class AddNewDiscountDto
    {
        ...
        ///آیدی محصولاتی که روی آنها تخفیف اعمال میکنیم 
